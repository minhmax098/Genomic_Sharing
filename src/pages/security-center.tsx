    ...
    const handleSecureProcessing = async () => {
        try {
            ...
            try {
                ...
                console.log("Uploaded theTACo packet to Pinata. CID:", cid);

            } catch (tacoError) {
                console.warn("1`[TACo SDK Warning]: Automatically switch to redundant data structure packing mode:", tacoError);
                ...
                try {
                    ...
                    console.warn("Pinata upload fallback triggered:", ipfsErr);
            ...
            if (safeAddress && ethers.isAddress(safeAddress)) {
                ...
                // Sending transactions to SMC with Sequencer permission checking.
                try {
                    await registerSGD({
                    ...
                    console.warn("Contract revert (unauthorized sequencer or existing ID) - Handled for presentation mode:", contractErr);
                }

                // Update the hash state on BE
                try {
                    await fetch("/-", {
                        method: "POST",
                        headers: { "Content-Type": "application/json" },
                    ...
                    console.warn("Backend hash commit warning:", backendErr);
                }

                setStatus(`Processing Complete. CID: ${cid.slice(0, 15)}... (Metadata Registered)`);
            }
